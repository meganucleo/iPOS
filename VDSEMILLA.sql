...
--
-- Host: localhost    Database: VDSEMILLA
-- ------------------------------------------------------
...
/* GRANT PERMISSIONS */
GRANT ALL ON {MYSQL_DB}.* TO {MYSQL_USR}@localhost IDENTIFIED BY '{MYSQL_PASS}';
...
INSERT INTO `APPLICATIONS` VALUES ('openbravopos','Openbravo POS','2.30');
...
INSERT INTO `CATEGORIES` VALUES ('000','Category Standard',NULL,NULL);
...
INSERT INTO `CLOSEDCASH` VALUES ('13e501a0-0d5f-47ca-8ce3-32d0016e4915','POS',2,'2011-04-04 13:33:20',NULL),('5b8c43cd-7f76-4c01-8291-f9c197a3f4c6','vdirectas',2,'2015-04-21 22:07:09',NULL),('7a9d9a49-cb3e-4ce9-9250-bf1c1a05a548','rafiki21',2,'2012-01-12 11:41:15',NULL),('b2e64f66-544d-475f-8c32-8fac88c986cc','laptop-aleon',2,'2010-07-28 18:05:05',NULL),('eab60ab1-0905-4b81-a04c-05aff613abbc','pos.delti.com.mx',2,'2010-07-28 19:28:27',NULL);
...
INSERT INTO `PEOPLE` VALUES ('0','Administrator','sha1:5BF619F06C3352AB2286BC754BC14A3991811A1A',NULL,'0','',NULL),('01a71f07-5d6d-40a1-853b-1da375f2b488','{POS_USR}',NULL,NULL,'1','',NULL),('1','Manager',NULL,NULL,'1','\0',NULL),('2','Employee',NULL,NULL,'2','\0',NULL),('3','Guest',NULL,NULL,'3','\0',NULL);
...
INSERT INTO `SHAREDTICKETS` VALUES ('27d7a20a-d308-4457-8339-84576b1de5fd','(11:17 55)','¬í\0sr\0#com.openbravo.pos.ticket.TicketInfo&a!Äêš\0\0xpt\0$d5838b1b-c1b9-4aff-b8ec-4cb1226d50a2w\0\0\0\0\0\0\0\0psr\0java.util.DatehjKYt\0\0xpw\0\0LçÊ?xsr\0java.util.Properties9Ğzp6>˜\0L\0defaultst\0Ljava/util/Properties;xr\0java.util.Hashtable»%!Jä¸\0F\0\nloadFactorI\0	thresholdxp?@\0\0\0\0\0w\0\0\0\0\0\0\0xpsr\0java.util.ArrayListxÒ™Ça\0I\0sizexp\0\0\0\0w\0\0\0\0xx');
...
INSERT INTO `TAXCATEGORIES` VALUES ('001','Con IVA'),('000','Sin IVA');
...
INSERT INTO `TAXES` VALUES ('000','Sin IVA','000',NULL,NULL,0,'\0',NULL),('001','Con IVA','001',NULL,NULL,0.16,'\0',NULL);
...
--
-- Dumping data for table `TICKETSNUM`
--

LOCK TABLES `TICKETSNUM` WRITE;
...
--
-- Dumping data for table `TICKETSNUM_PAYMENT`
--

LOCK TABLES `TICKETSNUM_PAYMENT` WRITE;
...
--
-- Dumping data for table `TICKETSNUM_REFUND`
--

LOCK TABLES `TICKETSNUM_REFUND` WRITE;
...
-- Dump completed on 2015-04-23 11:21:18
